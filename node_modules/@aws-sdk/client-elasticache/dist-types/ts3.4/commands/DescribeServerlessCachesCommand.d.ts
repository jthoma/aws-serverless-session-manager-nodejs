...
export { $Command };
export interface DescribeServerlessCachesCommandInput
  extends DescribeServerlessCachesRequest {}
export interface DescribeServerlessCachesCommandOutput
  extends DescribeServerlessCachesResponse,
    __MetadataBearer {}
